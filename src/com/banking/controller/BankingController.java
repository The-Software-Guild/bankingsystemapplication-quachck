...
public class BankingController {
	...
	private void assignBankAccountToCustomer() {
		...
		int bankAccountType = inputHandler
				.readInt("What account do you want to open?\n1. Savings Account\n2. Fixed Desposit Account");

		try {
			bankingService.assignBankAccountToCustomer(id, accountNumber, bsbCode, bankName, openingDate,
					bankAccountType);
		} catch (Exception e) {
